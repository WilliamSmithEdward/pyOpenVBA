...
| Formatting and layout | Basic font, fill, number format and alignment state exists; bold state loads/saves, including blank cells and bold-only edits | Audit other font persistence and editing of styles, borders, conditional formatting, validation, dimensions and page setup |
