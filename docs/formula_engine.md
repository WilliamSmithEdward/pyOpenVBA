...
81481d2 with its imports pointed at pyOpenVBA. Its modules keep their
...
to ed27bf2 so, and 94ea041's XIRR and 81481d2's PRICE, DURATION and
MDURATION, which touched no line pyOpenVBA changed, went in as their
diffs.
