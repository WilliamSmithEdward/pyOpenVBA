...
| `pcode_hash.py` | The `_VBA_PROJECT` identifier hash = OLE `LHashValOfNameSysA` (`h=0x0DEADBEE`, `37*h+LOOKUP[c]`, `% 65599 & 0xFFFF`), plus a byte-exact compact-record encoder. Exact on all measured names. |
